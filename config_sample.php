#!/usr/bin/env php
<?php
#remember this is a file to be executed by shell, do not place under public
# directories that can be served by apache, nginx or others web servers.
...
$src_sample_arr = Array(
        'type' => 'mysql',
        'sql_host'              => 'localhost',
        'sql_user'              => 'yourmysqluser',
        'sql_pass'              => '',
        'sql_db'                => 'yourdb',
...
$idx_sample_arr = Array(
        'source'                => 'sample',
        'path'                  => '/var/lib/sphinxlol/foo/whatever',
        'morphology'            => 'none',
        'min_word_len'          => 2,
        'min_prefix_len'        => 0,
        'min_infix_len'         => 0,
...
$builder->addEntry('index', 'sample', $idx_sample_arr);
